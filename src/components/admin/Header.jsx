...
export default function Header({ onAddMovieClick, onAddActorClick }) {
  ...
  return (
    <div className="flex dark:bg-secondary items-center justify-between relative p-5 ">
      <SearchForm
      ...
      <div className="flex items-center space-x-3">
        ...
        <button
          ...
          className="flex items-center space-x-2 dark:border-dark-subtle border-light-subtle border-secondary
